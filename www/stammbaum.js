						 ...
						 'buttons': [
							...
							{'title': 'Beispiel',
								...
								'callback': function(dlg) {
									dlg.data.find('textarea').val(exampleXML);
								}
							},
							{'title': 'Importieren',
							 'primary': true,
